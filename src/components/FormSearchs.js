...
/**
 * Componente de formulario para buscar el clima de una ciudad.
 *
 * @component
 * @param {Object} props - Props del componente.
 * @param {function} props.newLocation - Función que se llama al enviar el formulario con el nombre de la ciudad.
 * @param {function} props.onClear - Función que se llama al limpiar el formulario.
 * @example
 * return (
 *   <FormSearchs newLocation={newLocationHandler} onClear={clearHandler} />
 * )
 */
...
const FormSearchs = ({newLocation, onClear}) => {
   ...
   *
   * @param {Object} evento - El evento de envío del formulario.
   * @returns {void}
   */   
...
const onSubmit = (evento)=>{
  ...
  setError("");
  newLocation(city); // Llama a la función para buscar el clima de la ciudad ingresada.
}
/**
 ...
 /**
  ...
  const handleClear = () => {  
    setCity("");
    setError("");
    onClear(); // Llama a la función para limpiar los datos en el componente padre.
  };
